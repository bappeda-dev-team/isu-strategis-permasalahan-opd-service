...
type JumlahDataKebelakangResponse struct {
	Id            int      `json:"id"`
	IdDataDukung  int      `json:"id_data_dukung"`
	Tahun         string   `json:"tahun"`
	JumlahData    *float64 `json:"jumlah_data"`
	Satuan        string   `json:"satuan"`
	TahunSekarang bool     `json:"tahun_sekarang,omitempty"`
}
type DataDukungKebelakangResponse struct {
	Id                int                            `json:"id"`
	PermasalahanOpdId int                            `json:"permasalahan_opd_id"`
	DataDukung        string                         `json:"data_dukung"`
	NarasiDataDukung  string                         `json:"narasi_data_dukung"`
	JumlahData        []JumlahDataKebelakangResponse `json:"jumlah_data"`
}

type PermasalahanKebelakangResponse struct {
	Id           int                            `json:"id"`
	Permasalahan string                         `json:"masalah"`
	LevelPohon   int                            `json:"level_pohon"`
	JenisMasalah string                         `json:"jenis_masalah"`
	DataDukung   []DataDukungKebelakangResponse `json:"data_dukung"`
}

type IsuStrategisKebelakangResponse struct {
	Id               int                              `json:"id"`
	KodeOpd          string                           `json:"kode_opd"`
	NamaOpd          string                           `json:"nama_opd"`
	KodeBidangUrusan string                           `json:"kode_bidang_urusan"`
	...
	IsuStrategis     string                           `json:"isu_strategis"`
	CreatedAt        time.Time                        `json:"created_at"`
	PermasalahanOpd  []PermasalahanKebelakangResponse `json:"permasalahan_opd"`
}
